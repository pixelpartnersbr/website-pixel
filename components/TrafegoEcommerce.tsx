...
const faq: [string, string][] = [
  ...
  ["Preciso estar na plataforma Shopixel?", "Não — atendemos lojas virtuais em qualquer infraestrutura. Mas quem está na plataforma ganha a sinergia completa: Pixel Reports medindo a mídia na régua de venda líquida e CRM/fidelização multiplicando o cliente que o anúncio trouxe."],
