...
const faq: [string, string][] = [
  ...
  ["YouTube já vem incluso?", "O YouTube Ads é um add-on de R$ 450/mês, porque é uma disciplina de campanha diferente da busca do Google. Importante: o add-on cobre a gestão da mídia — a produção dos vídeos não está inclusa (essa é a praia da nossa frente de Redes Sociais, no plano Referência)."],
