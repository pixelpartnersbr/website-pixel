...
const addons = [
  ...
  { name: "Canal WhatsApp oficial", price: "R$ 199/mês por loja", alt: "tudo incluso · já vem no plano Scale", desc: "Dá voz de WhatsApp a tudo que seus módulos já fazem — campanhas do CRM, avisos de cashback, comissões de vendedor — mais leads do site, resumo diário e alerta de fraude.", href: "/whatsapp" },
