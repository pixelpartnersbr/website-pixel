      ...
      <div className="wrap grid items-center gap-12 lg:grid-cols-[1.1fr_.9fr]">
        <Reveal>
          ...
          <h2 className="mb-4 font-display text-[clamp(28px,3.6vw,46px)] font-black leading-[1.08] tracking-[-0.025em]">
            Shopixel: o e-commerce como ele deveria ser.
          </h2>
          ...
          <div className="flex flex-wrap gap-3.5">
            <a href={SHOPIXEL_URL} className="btn bg-navy-950 text-ink hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgba(2,22,39,.4)]">
