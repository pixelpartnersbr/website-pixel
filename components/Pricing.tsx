...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { t: "Módulo Atacadista: atacado e varejo na mesma loja, preços B2B por CNPJ", novo: true },
      { t: "Código de Vendedor: atribuição por vendedor com painel de comissões", novo: true },
      { t: "Canal WhatsApp oficial incluso", novo: true },
  ...
  {
    name: "Enterprise", tagline: "Para operações movidas a lançamento",
    job: "Drops, collabs e grupos VIP que derrubariam uma loja comum",
    monthly: null, orders: "800+ pedidos/mês · proposta personalizada",
    features: [
      { t: "Quando pico deixa de ser evento e vira rotina: infra, time e war-room trabalhando no seu calendário — não em 4 eventos por ano" },
      { t: "QueueGuard ilimitado — porque na sua operação, todo mês tem Black Friday" },
      { t: "Tudo do Scale + servidor 100% dedicado" },
      { t: "SLA contratual + suporte dedicado" },
